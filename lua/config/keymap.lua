...
map('n', '<C-j>', '<c-w>j', add_disc('Nav Down Pane'))
map('n', '<C-k>', '<c-w>k', add_disc('Nav Up Pane'))
map('n', '<C-l>', '<c-w>l', add_disc('Nav Right Pane'))
map('n', '<C-h>', '<c-w>h', add_disc('Nav Left Pane'))

-- Use jj as escape
map('i', 'jj', '<Esc>', add_disc('Set jj as Esc in insert mode'))
