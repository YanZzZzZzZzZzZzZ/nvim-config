...
let g:coq_settings = { "auto_start": "shut-up", "keymap.jump_to_mark": "<c-p" }
...
"set cc=88 " Show at 80 column a border for good code styleV
"highlight ColorColumn term=reverse ctermbg=1 guibg=#cb96d9
